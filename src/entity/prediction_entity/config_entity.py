...
class PredictionPipelineConfig:
    ...
    obj_det_artifact_dir = os.path.join(prediction_pipeline_config.artifact_dir,
                                        S3_OBJ_DET_DIR)

    text_det_artifact_dir = os.path.join(prediction_pipeline_config.artifact_dir,
                                         S3_TEXT_DET_DIR)
    ...
    html_output_file_path: str = os.path.join(prediction_pipeline_config.artifact_dir,
                                              HTML_FILE_OUTPUT_DIR,
                                              HTML_FILE_OUTPUT_NAME)
