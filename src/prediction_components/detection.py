...
class Detection:
    ...
    def get_model_files_from_s3(self) -> str:
        ...
        """
            Method Name :   get_model_files_from_s3
            Description :   This method downloads the models from s3 bucket
            Output      :   NA
    ...
    def get_obj_detection_predictions(self, input_image_file):

        """
                    Method Name :   get_obj_detection_predictions
                    Description :   This method does the object detection predictions
                    Output      :   NA
                    On Failure  :   Write an exception log and then raise an exception
    ...
    def get_text_detection_predictions(self, input_image_file):

        """
            Method Name :   get_text_detection_predictions
            Description :   This method does the text detection predictions
            Output      :   NA
            On Failure  :   Write an exception log and then raise an exception
    ...
    def initiate_detection(self, input_image_file) -> DetectionArtifact:
        """
            ...
            Description :   This method initiates the detection class
            Output      :   NA
            On Failure  :   Write an exception log and then raise an exception
        ...
        try:
            ...
            text_det_prediction_boxes, text_det_prediction_labels = self.get_text_detection_predictions(
                input_image_file)
